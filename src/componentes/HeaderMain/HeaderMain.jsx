        ...
        featured: [
          {
            name: 'New Arrivals',
            href: '#',
            imageSrc: 'https://cb.scene7.com/is/image/Crate/cb_dFO_20231226_Furniture_FlyoutV3',
            imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
          },
          {
            name: 'Basic Tables',
            href: '#',
            imageSrc: 'https://cb.scene7.com/is/image/Crate/KeaneCoffeeTableNatSOSSS24/$web_pdp_main_carousel_high$/240201143759/keane-weathered-natural-wood-storage-square-coffee-table.jpg',
        ...
        sections: [
          {
            ...
            items: [
            { name: 'Sofa and Sectional Collections', href: '/furniture/living-room/sofa-and-sectional-collections' },
        ...
        featured: [
          {
            name: 'New Arrivals',
            href: '#',
            imageSrc: 'https://cb.scene7.com/is/image/Crate/AlfrescoBlkChsLgSvCs3QSSS23_3D/$web_pdp_main_carousel_high$/240203165256/alfresco-ii-black-outdoor-chaise-lounge-with-silver-sunbrella-cushion.jpg',
            imageAlt: 'Drawstring top with elastic loop closure and textured interior padding.',
          },
          {
            name: 'Discontinued armchairs',
            href: '#',
            imageSrc: 'https://cb.scene7.com/is/image/Crate/CaymanSofaWhtSndCshSOSSS21/$web_pdp_main_carousel_high$/240201102205/abaco-outdoor-sofa-with-white-sand-sunbrella-cushions.jpg',
            imageAlt:
                        ...
                        <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                                    ...
                                    {category.featured.map((item) => (
                                      <div key={item.name} className="group relative text-sm">
                                        ...
                                        <a href={item.href} className="mt-6 block font-medium text-gray-900 ">
                                          <span className="absolute inset-0 z-10 category-text" aria-hidden="true" />
                                          {item.name}
                                        </a>
                          ...
                          <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                            <div className="flow-root">
                              <Link to="/IniciarSesion" className="-m-2 block p-2 font-medium text-gray-900">
                              Sign in
                              </Link>
                            </div>
                            <div className="flow-root">
                              <Link to="/RegistroUsuario" className="-m-2 block p-2 font-medium text-gray-900">
                                Create account
                              </Link>
                            </div>
                          </div>
                      ...
                      <div className="flex h-16 items-center">
                        ...
                        <div className="ml-auto flex items-center">
                          <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                            <Link to="/IniciarSesion" className="text-sm font-medium text-gray-700 hover:text-gray-800">
                              Sign in
                            </Link>
                            <span className="h-6 w-px bg-gray-200" aria-hidden="true" />
                            <Link to="/RegistroUsuario" className="text-sm font-medium text-gray-700 hover:text-gray-800">
                              Create account
                            </Link>
                          </div>
